...
<div class="content">
    ...
    <div class="container"> <br>
        <h3 class="mt-5">CATEGORY Data In UPDATE</h3> <br>
        ...
        <form action="CategoryCrud.php" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-lg-6" style="margin-top:100px;">

                    <div class="form-group wrap-input1">
                        <label for="name">CategoryName:</label>
                        <input type="text" class="form-control input1" id="name" placeholder="Enter Your Category name"
                ...
                <div class="col-sm-12 col-lg-4 ">
                    ...
                    <div class="d-flex flex-column align-items-center text-center  user-profile-image mt-3">
                        ...
                        <?php if(@$res['categoryImg'] != null){?>

                        <img class="mt-5" style="width:250px;" src="<?=@$res['categoryImg']?>" id="UserImage">
