...
<a href="Category.php" class = "btn btn-success m-5">INSERT MORE RECORDS</a>
...
if($rowCount > 0){
 ...
 <table class=" container table table-stripped table-bordered" style = "width:80%">
    ...
    <?php while($data = mysqli_fetch_assoc($res)){ echo '<tr>';?>
                    ...
                    <td> <img src= "<?=@$data['categoryImg']?>"  alt="databaseImg" style = "width:100px;"> </td>
                    <td><a href="CategoryEdit.php?id=<?=@$data['categoryId']?>" class = "btn btn-primary">Edit</a>
                    <a href="CategoryView.php?Delid=<?=@$data['categoryId']?>" class = "btn btn-danger" onclick = "return confirm('Are you sure you want to delete');return false;">Delete</a>
                    </td>
...
if ($res) {
    echo "<script>alert('Data Deleted!!');window.location.href = 'CategoryView.php';</script>";
