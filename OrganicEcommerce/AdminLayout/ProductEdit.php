    ...
    <div class="container"> <br>
        ...
        <form action="ProductCrud.php" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <input type="hidden" name="CatId" value=<?= @$res['productId'] ?>>
                ...
                <div class="col-sm-12 col-lg-6" style="margin-top:50px;">
                    ...
                    <div class="form-group wrap-input1">
                        ...
                        <input type="text" class="form-control input1" id="name" placeholder="Enter Your Product Name"
                            name="name" value=<?= @$res['categoryName'] ?>>
                    </div>
                    <div class="form-group wrap-input1">
                    ...
                    <div class="form-group wrap-input1">
                        ...
                        <select class="form-control wrap-input1" id="cat" name="Category">
                            ...
                            <option value="" <?php if($res['Category'] == ''){ echo 'selected';} ?>>--Select--</option>
                            <?php
                                $query = "select * from category";
                                $rs = mysqli_query($con,$query);
                                if(mysqli_num_rows($rs) > 0){
                                    while($data  = mysqli_fetch_array($rs)){?>
                            <option value="<?php echo $data['categoryId'] ?>" <?php if($res['Category'] == "$data['categoryId']"){ echo 'selected';} ?>><?= $data['categoryName']?></option>
                            <?php
                            }
                            }else{  ?>
                    ...
                    <button type="submit" class="btn btn-success" name="Upd">Submit</button>
                ...
                <div class="col-sm-12 col-lg-4 ">
                    ...
                    <div class="d-flex flex-column align-items-center text-center  user-profile-image mt-3">
                        ...
                        <?php if(@$res['prodImg'] != null){?>

                        <img class="mt-5" style="width:250px;" src="<?=@$res['prodImg']?>" id="UserImage">

                        <?php }else{
echo "<img class='mt-5' style='width:250px;' src='assets/images/noImg.jpg' id='UserImage'>";
}?>
