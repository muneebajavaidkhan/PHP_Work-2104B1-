...
<a href="Product.php" class = "btn btn-success m-5">INSERT MORE RECORDS</a>
...
if($rowCount > 0){
 ...
 <table class=" container table table-stripped table-bordered" style = "width:80%">
    ...
    <?php while($data = mysqli_fetch_assoc($res)){ echo '<tr>';?>
                    ...
                    <td> <img src= "<?=@$data['prodImg']?>"  alt="databaseImg" style = "width:100px;"> </td>
                    <td><a href="ProductEdit.php?id=<?=@$data['productId']?>" class = "btn btn-primary">Edit</a>
                    <a href="ProductView.php?Delid=<?=@$data['productId']?>" class = "btn btn-danger" onclick = "return confirm('Are you sure you want to delete');return false;">Delete</a>
                    </td>
...
if ($res) {
    echo "<script>alert('Data Deleted!!');window.location.href = 'ProductView.php';</script>";
